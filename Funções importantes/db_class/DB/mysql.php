...
// +----------------------------------------------------------------------+
//
// $Id: mysql.php,v 1.1.1.3 2007-11-05 16:43:56 glauber Exp $
//
...
class DB_mysql extends DB_common
{
    ...
    function connect($dsninfo, $persistent = true)
    {
        ...
        //$connect_function = $persistent ? 'mysql_pconnect' : 'mysql_pconnect';
